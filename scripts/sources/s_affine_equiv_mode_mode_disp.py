...
# ## [Step 3](https://www.arpm.co/lab/redirect.php?permalink=s_affine_equiv_mode_mod_disp-implementation-step03): Perform computations for the plots
...
plt.plot(x_bar[:, 0], x_bar[:, 1], color='b', linewidth=3, label=r'Loc-disp ellipsoid of $\boldsymbol{X}$')
plt.plot(y_bar[:, 0], y_bar[:, 1], color='r', linewidth=3, label=r'Loc-disp ellipsoid of $\boldsymbol{Y}$')

...
# ## [Step 1](https://www.arpm.co/lab/redirect.php?permalink=s_logn_quant_regression-implementation-step01): Generate samples
...
xhat = chi(z)
u = x-xhat
q_x_z = [q_x_z_u(x_grid, quant) for quant in u_quantiles]
# -

# ## [Step 3](https://www.arpm.co/lab/redirect.php?permalink=s_logn_quant_regression-implementation-step03): Expectation and covariance of (Xhat, U)
...
[ax1.plot(x_grid, q_x_z[i], c=grey, lw=1) for i in range(1, len(u_quantiles))]

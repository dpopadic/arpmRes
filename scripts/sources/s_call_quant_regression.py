...
# # s_call_quant_regression [<img src="https://www.arpm.co/lab/icons/icon_permalink.png" width=30 height=30 style="display: inline;">](https://www.arpm.co/lab/redirect.php?code=s_call_quant_regression&codeLang=Python)
# For details, see [here](https://www.arpm.co/lab/redirect.php?permalink=s_call_quant_regression).
...
from arpym.estimation import smooth_kernel_fp
from arpym.statistics import quantile_sp
from arpym.tools.logo import add_logo
# -

# ## [Input parameters](https://www.arpm.co/lab/redirect.php?permalink=s_call_quant_regression-parameters)

c = 0.5  # quantile level
delta_t = 100  # horizon parameter

# ## [Step 0](https://www.arpm.co/lab/redirect.php?permalink=s_call_quant_regression-implementation-step00): Load data
...
# ## [Step 1](https://www.arpm.co/lab/redirect.php?permalink=s_call_quant_regression-implementation-step01): Compute returns
...
# ## [Step 2](https://www.arpm.co/lab/redirect.php?permalink=s_call_quant_regression-implementation-step02): Approximate median of the conditional distribution X|z
...
ax1.scatter(r_sandp[j_plot], r_call[j_plot], s=markersize,
            c=[light_grey])
l5, = ax1.plot(z_grid, q_r_call_tnow_thor_given_z_grid, c=orange, lw=1.5)

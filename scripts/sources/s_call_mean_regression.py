...
# # s_call_mean_regression [<img src="https://www.arpm.co/lab/icons/icon_permalink.png" width=30 height=30 style="display: inline;">](https://www.arpm.co/lab/redirect.php?code=s_call_mean_regression&codeLang=Python)
# For details, see [here](https://www.arpm.co/lab/redirect.php?permalink=s_call_mean_regression).
...
# ## [Input parameters](https://www.arpm.co/lab/redirect.php?permalink=s_call_mean_regression-parameters)

delta_t = 100  # horizon parameter

# ## [Step 0](https://www.arpm.co/lab/redirect.php?permalink=s_call_mean_regression-implementation-step00): Upload data
...
# ## [Step 1](https://www.arpm.co/lab/redirect.php?permalink=s_call_mean_regression-implementation-step01): Compute returns
...
# ## [Step 2](https://www.arpm.co/lab/redirect.php?permalink=s_call_mean_regression-implementation-step02): Approximate mean of the conditional distribution X|z
...
ax1.scatter(r_sandp[j_plot], r_call[j_plot], s=markersize,
            c=[light_grey])
l5, = ax1.plot(z_grid, e_r_call_tnow_thor_given_z_grid, c=orange, lw=1.5)
...
fig.legend((l1, l2, l3, l4, l5, l6, l9, l7),
           ('Input', 'Output', 'Predictor', 'Residual', 'Cond. exp',

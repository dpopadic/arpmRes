...
# # S_AnalyzeLognormalCorrelation [<img src="https://www.arpm.co/lab/icons/icon_permalink.png" width=30 height=30 style="display: inline;">](https://www.arpm.co/lab/redirect.php?code=S_AnalyzeLognormalCorrelation&codeLang=Python)
# For details, see [here](https://www.arpm.co/lab/redirect.php?permalink=eb-cor-lognorm-copy-1).
...
import numpy as np
from numpy import arange, array, zeros, sort, argsort, diag, exp, sqrt
...
for n in range(n_):
    ...
    E_X = exp(mu + 0.5 * diag(sig2))  # expectation vector
    Cv_X = E_X@E_X.T * (exp(sig2) - 1)  # covariance matrix
